...
*
* File:         dbuffer.c
* RCS:          $Header: /ImageMagick/delegates/fpx/jpeg/dbuffer.c,v 1.4 2002/03/02 22:59:59 bfriesen Exp $
...
static void
Clear_Buffer(unsigned char *buf,
int size)
{
...
static void
Prepare_New_Buffers_From_Supplied_Buffer(
DB_STATE *db_state)
{
  int i, size;
