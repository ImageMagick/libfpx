...
*
* File:         djpeg.c
* RCS:          $Header: /ImageMagick/delegates/fpx/jpeg/djpeg.c,v 1.2 2000/12/23 22:37:48 bfriesen Exp $
...
static int
Read_Bytes_From_Memory(DB_STATE *db_state,
unsigned char *buf,
int nbytes)
{
  int i;
...
static void
Write_Rows_To_Memory(unsigned char *membuf,
unsigned char *data,
int nrows,
int nbytes_per_row)
{
